...
func Test_addTargetExecutionProperties(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: map[string]string{
				"dt.entity.cloud_application":           "1614217772",
				"dt.entity.cloud_application_instance":  "1101741179",
				"dt.entity.cloud_application_namespace": "4094933161",
				"dt.entity.kubernetes_cluster":          "1841244547",
				"dt.entity.kubernetes_node":             "4129093950",
				"steadybit.execution.id":                "42",
